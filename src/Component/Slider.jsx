  ...
  return (
    <div className="max-w-[1400px] h-[450px] w-full m-auto relative group">
      <div style={{backgroundImage: `url(${slides[currIndex].background})`}} 
        ...
        <div  
          className="hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] left-5 text-2xl text-gray-400 cursor-pointer">
          < IoIosArrowBack size={30} onClick={prevSlide}  />
        </div>
        <div 
          className="hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 text-2xl text-gray-400 cursor-pointer">
